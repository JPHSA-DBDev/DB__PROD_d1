...
SELECT        
			...
			M1.JPHSA_Tag AS [Monitor_1],
			M2.JPHSA_Tag AS [Monitor_2],
			M3.JPHSA_Tag AS [Monitor_3],
...
FROM            
			...
			ON IP.[Monitor_1_FK] = M1.T006_Monitor_Inventory_PK

			Left outer JOIN
			T006_Monitor_Inventory M2
			ON IP.[Monitor_2_FK] = M2.T006_Monitor_Inventory_PK

			Left outer JOIN
			T006_Monitor_Inventory M3
			ON IP.[Monitor_3_FK] = M3.T006_Monitor_Inventory_PK
