...
--==============================================
		...
		ON i.[Attached_T004_IP_Device_1_FK] = i_1.T004_IP_Inventory_PK 

		LEFT OUTER JOIN
		T004_IP_Inventory AS i_2 
		ON i.[Attached_T004_IP_Device_2_FK] = i_2.T004_IP_Inventory_PK 

		LEFT OUTER JOIN
		T004_IP_Inventory AS i_3 
		ON i.[Attached_T004_IP_Device_3_FK] = i_3.T004_IP_Inventory_PK 

		LEFT OUTER JOIN
		T006_Monitor_Inventory m
		ON i.[Monitor_1_FK] = m.T006_Monitor_Inventory_PK 

		LEFT OUTER JOIN
		T006_Monitor_Inventory m_1
		ON i.[Monitor_2_FK] = m_1.T006_Monitor_Inventory_PK

		LEFT OUTER JOIN
		T006_Monitor_Inventory m_2
		ON i.[Monitor_3_FK] = m_2.T006_Monitor_Inventory_PK 
